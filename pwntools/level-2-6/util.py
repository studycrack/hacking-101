...
def print_desc_name(pokemon_name):
    ...
    fmt = "### Before officially challenging " + f"[bold cyan]{pokemon_name}[/bold cyan]" + \
          ", please read and study the battle tips in the description carefully."
    console.print(fmt)
    print("### If it's too difficult, try defeating lower-level Pokémon first.")
    print("### Good luck! :)")
    print("###")

def print_battle_result(name, color):
    print("\n### ", end="")
    fmt = "Battle Log: " + f" [bold {color}]{name}[/bold {color}] " + "has won!\n"
    console.log(fmt)
    print("### Come back after improving your level!\n")
