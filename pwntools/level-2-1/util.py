...
def print_desc_name(pokemon_name):
    ...
    print("###")
    fmt = "### Before officially challenging " + f"[bold cyan]{pokemon_name}[/bold cyan]" + ", please carefully read and learn the battle techniques in the description."
    console.print(fmt)
    print("### If you find it too difficult, try battling lower-level Pokémon first.")
    print("### Good luck :)")
    print("###")
