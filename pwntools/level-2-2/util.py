...
def print_desc_name(pokemon_name):
    ...
    print("###")
    fmt = "### Before officially challenging " + f"[bold cyan]{pokemon_name}[/bold cyan]" + ", please carefully read and study the battle tips in the description."
    console.print(fmt)
    print("### If you find it too difficult, try battling other lower-level Pokémon first.")
    print("### Good luck :)")
    print("###")

def print_battle_result(name, color):
    print("\n### ", end="")
    fmt = "Battle record: " + f"[bold {color}]{name}[/bold {color}] " + "won\n"
    console.log(fmt)
    print("### Come back to challenge again after leveling up!\n")
